"""
Django settings for mapinskhu project.
...
def get_secret(secret_key, secrets=secrets):
    try:
...
ALLOWED_HOSTS = [
    "ec2-3-35-216-0.ap-northeast-2.compute.amazonaws.com"
]
...
WSGI_APPLICATION = 'mapinskhu.wsgi.application'
